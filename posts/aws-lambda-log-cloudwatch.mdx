...
[Filtering Cloudwatch Logs using Python and boto3 SDK](https://www.thelambdablog.com/filtering-cloudwatch-logs-by-loggroups-and-logstreams-and-reading-them-using-python-and-the-boto3-sdk)
