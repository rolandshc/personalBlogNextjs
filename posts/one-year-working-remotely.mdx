...
The remote worker has to have at least a certain degree of independence. The feeling of loneliness and isolation 😩 might be an issue for some people. There might be some misunderstanding about the task assigning, progress and requirements from different parties. For a distributed team, it might be not easy to build trust between each other with only virtual meetings and slack channels. People have emotions. When people start to have more free time, it also needs a new way to work more efficiently with a healthy mental condition. What I keep doing is to praising 👏and thanking 🙏 others' efforts with the words speaking out directly. This is huge and emojis could not do the same.😁
