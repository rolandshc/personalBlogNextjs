          ...
          <div className="flex flex-col items-center md:flex-row md:justify-between">
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start items-center space-x-4 mt-4 md:mt-0">
                <a
                  ...
                  className="text-gray-900 dark:text-white px-3 py-2 flex items-center"
                  target="_blank"
            ...
            <div className="mt-4 md:mt-0 text-center md:text-right">
              <span className="text-gray-500 block">
                All things are so very uncertain, and that's exactly what makes
                me feel reassured.
              </span>
              <span className="text-gray-500 block mt-2">Tove Jansson</span>
            </div>
          </div>
        </div>
      </footer>
